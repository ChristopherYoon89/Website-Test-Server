...
urlpatterns = [
	...
	path('job-applied/', views.JobApplicationRedirectView.as_view(), name='job-applied-completed-page'),
	path('contact/', views.contactview, name='contact'),
	path('message-sent', views.ContactRedirectView.as_view(), name='contact-redirect-page'),
	path('newsletter/', views.newsletterview, name='newsletter-page'),
	path('signup-completed/', views.NewsletterRedirectView.as_view(), name='signup-completed-page'),
	path('newsletter-unsubscribe/', views.newsletterunsubscribeview, name='newsletter-unsubscribe-page'),
	path('unsubscribe-requested/', views.NewsletterUnsubRedirectView.as_view(), name='newsletter-unsubscribe-completed-page'),
	...
	path('de/nachricht-gesendet/', blog_ger_views.ContactRequestGerRedirectView.as_view(), name='contact-redirect-page-ger'),
	path('de/newsletter/', blog_ger_views.newsletterview_ger, name='newsletter-page-ger'),
	path('de/signup-abgeschlossen/', blog_ger_views.NewsletterSubscribeGerRedirectView.as_view(), name='signup-completed-page-ger'),
	...
	path('de/bewerbung-abgeschlossen/', blog_ger_views.JobApplicationGerRedirectView.as_view(), name='job-applied-completed-page-ger'),
