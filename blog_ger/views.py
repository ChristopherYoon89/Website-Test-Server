...
def contactview_ger(request):
    if request.method == 'POST':
        ...
        if l_form.is_valid():
            l_form.save()
            return redirect('contact-redirect-page-ger')
    else:
        l_form = ContactForm()
...
def newsletterview_ger(request):
    if request.method == 'POST':
        ...
        if n_form.is_valid():
            n_form.save()
            return redirect('signup-completed-page-ger')
    else:
...
class ContactRequestGerRedirectView(TemplateView):
    '''
    View that is redirected to when user sent a contact request
    '''
    template_name = 'blog_ger/contact_ger_redirect.html'



class JobApplicationGerRedirectView(TemplateView):
    '''
    View that is redirected to when user sent job application
    '''
    template_name = 'blog_ger/jobapplication_ger_redirect.html'



class NewsletterSubscribeGerRedirectView(TemplateView):
    '''
    View that is redirected to when user signs up to newsletter
    '''
    template_name = 'blog_ger/newsletter_ger_redirect.html'
...
class JobApplicationFormGermanView(SuccessMessageMixin, FormView):
    ...
    success_url = reverse_lazy('job-applied-completed-page-ger')
